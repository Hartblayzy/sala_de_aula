...
#RESULTADO 9
      ...
      print(f"Emprestimo: R$ {emprestimo:.2f} | Parcela Mensal: R$ {parcela_mensal:.2f} | Total Pago: R$ {total_pago:.2f}")
...
#RESULTADO 10
      ...
      dist = calcular_distancia (1, 2, 4, 6)

      print (f'A distância entre (1, 2) e (4, 6) é de {dist:.2f}')
